...
destinations = {
    ...
    "mountains": ["Swiss Alps","Rocky Mountains", "Himalayas","Denali" ],
    "cities": ["Paris","London","Amsterdam"]
}
jokes = [
    "Why don't programmers like nature? Too many bugs", "Why did the computer go to the doctor? Because it has a virus!",
...
# Provide travel recommendations (recursive if user rejects suggesions)
def recommend():
...
#Offer packing tips based on destination and duration of user trip
def packing_tips():
...
def chat():
    ...
    while True:
        ...
        if "recommend" in user_input or "suggest" in user_input:
            ...
            print(Fore.CYAN + "TravelBot: Safe Have a safe trip!Good Bye!")
            break
        else:
